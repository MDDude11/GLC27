...
export const SOUND_SETTINGS_VERSION_KEY = "glt_drafts_sound_settings_v2";
...
export function loadSettings() {
  ...
  try {
    ...
    if (currentRaw) {
      ...
      const needsSoundDefaultMigration = localStorage.getItem(SOUND_SETTINGS_VERSION_KEY) !== "2";
      const merged = {
        ...DEFAULT_SETTINGS,
        ...parsed,
        ...(needsSoundDefaultMigration ? { soundEffects: false } : {})
      };
      if (needsSoundDefaultMigration) localStorage.setItem(SOUND_SETTINGS_VERSION_KEY, "2");
      return merged;
    }
    ...
    for (const key of LEGACY_SETTINGS_KEYS) {
      ...
      localStorage.setItem(SOUND_SETTINGS_VERSION_KEY, "2");
