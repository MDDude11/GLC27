...
const WRITE_QUEUE_KEY = "glt_drafts_firebase_write_queue_v22_5";
const PREVIOUS_WRITE_QUEUE_KEYS = ["glt_drafts_firebase_write_queue_v22", "glt_drafts_firebase_write_queue_v21", "glt_drafts_firebase_write_queue_v20"];
